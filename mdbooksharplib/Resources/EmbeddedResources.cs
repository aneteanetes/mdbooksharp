...
namespace mdbooksharplib.Resources
{
    public class EmbeddedResources
    {
        ...
        private const string _exeName = "mdbooksharplib"; 

        private static string ResourceRoot = $"{_exeName}.Resources.";
        ...
        public static string GetEmbeddedFileContent(string relativeFilePath)
        {
            ...
            var res = relativeFilePath.Contains(ResourceRoot)
                ? relativeFilePath
                : $"{_exeName}.Resources.{Embedded(relativeFilePath)}";
